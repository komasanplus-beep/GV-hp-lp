...
export const UI_CONFIGS = {
  hotel: {
    ...
    layout: {
      ...
      service_card_height: 'h-96',
      service_image_height: 'h-48',
      gallery_columns: 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3',
    ...
    nav_items: ['About', 'Rooms', 'Facilities', 'Gallery', 'Access', 'Contact'],
    animation_preset: 'luxury',
    default_blocks: ['Hero', 'About', 'Service', 'Feature', 'Gallery', 'Access', 'Contact'],
  },
  ...
  salon: {
    ...
    nav_items: ['About', 'Menu', 'Staff', 'Gallery', 'Voice', 'FAQ', 'Contact'],
    animation_preset: 'light',
    default_blocks: ['Hero', 'About', 'Service', 'Staff', 'Gallery', 'Voice', 'FAQ', 'Contact'],
  },
