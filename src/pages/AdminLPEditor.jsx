...
import {
  ChevronUp, ChevronDown, Pencil, Trash2, Plus, ExternalLink, ArrowLeft, Globe, FileText
} from 'lucide-react';

const ALL_BLOCK_TYPES = ['Hero','Problem','Solution','Feature','Evidence','Voice','Flow','Comparison','FAQ','CTA','Future'];
